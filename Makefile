...
pkgdatadir = $(datadir)/inform
pkglibdir = $(libdir)/inform
pkgincludedir = $(includedir)/inform
top_builddir = .
...
ACLOCAL = ${SHELL} /root/inform-6.30/config/missing --run aclocal-1.7
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /root/inform-6.30/config/missing --run tar
AUTOCONF = ${SHELL} /root/inform-6.30/config/missing --run autoconf
AUTOHEADER = ${SHELL} /root/inform-6.30/config/missing --run autoheader
AUTOMAKE = ${SHELL} /root/inform-6.30/config/missing --run automake-1.7
AWK = gawk
CC = gcc
...
CYGWIN_FALSE = 
CYGWIN_TRUE = #
DEFS = -DPACKAGE_NAME=\"inform\" -DPACKAGE_TARNAME=\"inform\" -DPACKAGE_VERSION=\"6.30\" -DPACKAGE_STRING=\"inform\ 6.30\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE=\"inform\" -DVERSION=\"6.30.1\" 
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/inform-6.30/config/missing --run makeinfo
OBJEXT = o
PACKAGE = inform
PACKAGE_BUGREPORT = 
PACKAGE_NAME = inform
PACKAGE_STRING = inform 6.30
...
infodir = ${prefix}/info
install_sh = /root/inform-6.30/config/install-sh
...
DIST_COMMON = README $(srcdir)/Makefile.in $(srcdir)/configure AUTHORS \
	COPYING INSTALL Makefile.am NEWS aclocal.m4 config/config.guess \
